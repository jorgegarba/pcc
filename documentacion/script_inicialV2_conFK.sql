...
INSERT INTO `area` VALUES (1,'Informática'),(2,'Electrotecnia');
...
CREATE TABLE `carrera` (
  ...
  `nom_carr` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
...
INSERT INTO `carrera` VALUES (1,'Diseño de Sofware e Integración de Sistemas',1),(2,'Redes y Comunicaciones de Datos',1),(3,'Electrotecnia Industrial',2),(4,'Operaciones Eléctricas',2);
...
INSERT INTO `curso` VALUES (1,'Fundamentos de la Programación'),(2,'Algoritmos y Estructuras de Gatos'),(3,'Base de Gatos'),(4,'Programación Orientada a Objetos');
...
INSERT INTO `cursosemestrecarrera` VALUES (1,1,1),(2,2,1);
...
INSERT INTO `persona` VALUES (1,'Jorge','Garnica','47040062','1991-08-09','H','jorgegarba@gmail.com','974204853','Calle Blondell 105 Miraflores','jgarnica','123',2),(3,'Jack','Bustinza','77777777','1997-07-07','M','jbustinza@tecsup.edu.pe','974526341','Calle asd asda asd asd as','jbustinza','jbustinza',1),(4,'Juan','Pino','66666666','2017-01-01','H','jpino@tecsup.edu.pe','974204853','Calle Blondell 105 Miraflores','jpino','jpino',1);
...
CREATE TABLE `semestrecarrera` (
  ...
  KEY `fk_SemestreCarrera_Carrera_idx` (`id_carr`),
  CONSTRAINT `fk_SemestreCarrera_Carrera` FOREIGN KEY (`id_carr`) REFERENCES `carrera` (`id_carr`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `semestrecarrera` VALUES (1,1,1),(2,2,1);
...
INSERT INTO `tipopersona` VALUES (1,'alumno'),(2,'docente');
...
-- Dump completed on 2017-06-05 17:56:06
